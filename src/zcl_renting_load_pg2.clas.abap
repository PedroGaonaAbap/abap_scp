CLASS zcl_renting_load_pg2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_pg2 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

 DATA: lt_brands    TYPE TABLE OF zrent_brands_pg2,
       lt_cars      TYPE TABLE OF zrent_cars_pg2,
       lt_customers TYPE TABLE OF zrent_cli_pg2.
...
DELETE FROM zrent_brands_pg2.
INSERT zrent_brands_pg2 FROM TABLE @lt_brands.
SELECT * FROM zrent_brands_pg2 INTO TABLE @lt_brands.
out->write( sy-dbcnt ).
...
combustible = 'GASOLINA' consumo = '10.00' fecha_fabr = '20200617' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20200801' alq_hasta = '20240831' )
( matricula = '2356FSF' marca = 'AUDI' modelo = 'A8' color = 'BLANCO' motor = '3.9' potencia = '140' und_potencia = 'CV'
combustible = 'ELECTRIC' consumo = '00.00' fecha_fabr = '20200304' puertas = '3' precio = '140' moneda = 'USD' alquilado = 'X' alq_desde = '20210701' alq_hasta = '20240708' )
( matricula = '2392JFH' marca = 'JEEP' modelo = 'GRAND CHEROKEE' color = 'BLANCO' motor = '3.6' potencia = '176' und_potencia = 'CV'
combustible = 'GASOLINA' consumo = '12.00' fecha_fabr = '20200924' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20200601' alq_hasta = '20241001' )
( matricula = '2837KFF' marca = 'MERCEDES' modelo = 'CLASE B' color = 'NEGRO' motor = '2.0' potencia = '200' und_potencia = 'CV'
combustible = 'GASOLINA' consumo = '7.00' fecha_fabr = '20200726' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20200301' alq_hasta = '20240701' )
...
DELETE FROM zrent_cars_pg2.
INSERT zrent_cars_pg2 FROM TABLE @lt_cars.
SELECT * FROM zrent_cars_pg2 INTO TABLE @lt_cars.
out->write( sy-dbcnt ).
...
DELETE FROM zrent_cli_pg2.
INSERT zrent_cli_pg2 FROM TABLE @lt_customers.
SELECT * FROM zrent_cli_pg2 INTO TABLE @lt_customers.
out->write( sy-dbcnt ).
